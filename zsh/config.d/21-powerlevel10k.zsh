# Generated by Powerlevel10k configuration wizard on 2022-07-11 at 11:01 PDT.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%010F'  # pink foreground
      local   modified='%011F'  # purple foreground
      local  untracked='%012F'  # orange foreground
  ...
  #
  typeset -g POWERLEVEL9K_ASDF_NODEJS_SHOW_ON_UPGLOB='*.js|package.json|*.ts'
